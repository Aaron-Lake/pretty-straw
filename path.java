...
Caused by: org.springframework.beans.factory.UnsatisfiedDependencyException: Error creating bean with name 'classInfoServiceImpl': Unsatisfied dependency expressed through field 'baseMapper'; nested exception is org.springframework.beans.factory.UnsatisfiedDependencyException: Error creating bean with name 'classInfoMapper' defined in file [C:\Users\think\IdeaProjects\prettystraw\straw-api-user\target\classes\cn\tedu\straw\api\user\mapper\ClassInfoMapper.class]: Unsatisfied dependency expressed through bean property 'sqlSessionFactory'; nested exception is org.springframework.beans.factory.BeanCreationException: Error creating bean with name 'sqlSessionFactory' defined in class path resource [com/baomidou/mybatisplus/autoconfigure/MybatisPlusAutoConfiguration.class]: Bean instantiation via factory method failed; nested exception is org.springframework.beans.BeanInstantiationException: Failed to instantiate [org.apache.ibatis.session.SqlSessionFactory]: Factory method 'sqlSessionFactory' threw exception; nested exception is org.springframework.core.NestedIOException: Failed to parse mapping resource: 'file [C:\Users\think\IdeaProjects\prettystraw\straw-api-user\target\classes\mapper\UserMapper.xml]'; nested exception is org.apache.ibatis.builder.BuilderException: Error parsing Mapper XML. The XML location is 'file [C:\Users\think\IdeaProjects\prettystraw\straw-api-user\target\classes\mapper\UserMapper.xml]'. Cause: org.apache.ibatis.builder.BuilderException: Error resolving class. Cause: org.apache.ibatis.type.TypeException: Could not resolve type alias 'cn.tedu.straw.api.user.model.model.User'.  Cause: java.lang.ClassNotFoundException: Cannot find class: cn.tedu.straw.api.user.model.model.User
...
Caused by: org.springframework.core.NestedIOException: Failed to parse mapping resource: 'file [C:\Users\think\IdeaProjects\prettystraw\straw-api-user\target\classes\mapper\UserMapper.xml]'; nested exception is org.apache.ibatis.builder.BuilderException: Error parsing Mapper XML. The XML location is 'file [C:\Users\think\IdeaProjects\prettystraw\straw-api-user\target\classes\mapper\UserMapper.xml]'. Cause: org.apache.ibatis.builder.BuilderException: Error resolving class. Cause: org.apache.ibatis.type.TypeException: Could not resolve type alias 'cn.tedu.straw.api.user.model.model.User'.  Cause: java.lang.ClassNotFoundException: Cannot find class: cn.tedu.straw.api.user.model.model.User
	...
	at com.baomidou.mybatisplus.autoconfigure.MybatisPlusAutoConfiguration$$EnhancerBySpringCGLIB$$14f91f88.CGLIB$sqlSessionFactory$0(<generated>)
	at com.baomidou.mybatisplus.autoconfigure.MybatisPlusAutoConfiguration$$EnhancerBySpringCGLIB$$14f91f88$$FastClassBySpringCGLIB$$ab81024f.invoke(<generated>)
	at org.springframework.cglib.proxy.MethodProxy.invokeSuper(MethodProxy.java:244)
	at org.springframework.context.annotation.ConfigurationClassEnhancer$BeanMethodInterceptor.intercept(ConfigurationClassEnhancer.java:331)
	at com.baomidou.mybatisplus.autoconfigure.MybatisPlusAutoConfiguration$$EnhancerBySpringCGLIB$$14f91f88.sqlSessionFactory(<generated>)
...
Caused by: org.apache.ibatis.builder.BuilderException: Error parsing Mapper XML. The XML location is 'file [C:\Users\think\IdeaProjects\prettystraw\straw-api-user\target\classes\mapper\UserMapper.xml]'. Cause: org.apache.ibatis.builder.BuilderException: Error resolving class. Cause: org.apache.ibatis.type.TypeException: Could not resolve type alias 'cn.tedu.straw.api.user.model.model.User'.  Cause: java.lang.ClassNotFoundException: Cannot find class: cn.tedu.straw.api.user.model.model.User
	...
	... 120 more
Caused by: org.apache.ibatis.builder.BuilderException: Error resolving class. Cause: org.apache.ibatis.type.TypeException: Could not resolve type alias 'cn.tedu.straw.api.user.model.model.User'.  Cause: java.lang.ClassNotFoundException: Cannot find class: cn.tedu.straw.api.user.model.model.User
	...
	... 122 more
Caused by: org.apache.ibatis.type.TypeException: Could not resolve type alias 'cn.tedu.straw.api.user.model.model.User'.  Cause: java.lang.ClassNotFoundException: Cannot find class: cn.tedu.straw.api.user.model.model.User
	at org.apache.ibatis.type.TypeAliasRegistry.resolveAlias(TypeAliasRegistry.java:120)
	at org.apache.ibatis.builder.BaseBuilder.resolveAlias(BaseBuilder.java:149)
	at org.apache.ibatis.builder.BaseBuilder.resolveClass(BaseBuilder.java:116)
	... 126 more
Caused by: java.lang.ClassNotFoundException: Cannot find class: cn.tedu.straw.api.user.model.model.User
